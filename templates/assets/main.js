...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "wJpHo1ebMIYkBjHGeVYBKS01QT66kkXuGQ29S8Z9AVZemGnifwufSEEVUggsXQnl";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type='hidden' name='csrfmiddlewaretoken' value='wJpHo1ebMIYkBjHGeVYBKS01QT66kkXuGQ29S8Z9AVZemGnifwufSEEVUggsXQnl' />
    <table>
